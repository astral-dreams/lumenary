...
Source ID: physics-measurement-problem
Tradition: Physics / Philosophy of Physics
Type: paper
Agent: claude
Key Sources: Bohr/Heisenberg (~1927); Von Neumann (1932); Wigner (1961); Everett (1957); Fuchs/Schack (~2010, QBism)

## Core Problem

Systems exist in superpositions until measurement produces a definite outcome. What constitutes "measurement"? Where does the Schrodinger equation give way to definite results?
...
**Established:** Measurement outcomes are contextual (Kochen-Specker); complementarity (Heisenberg uncertainty); Bell's theorem violations (Nobel 2022); delayed-choice experiment (history not fixed until measurement complete).

**NOT established:** Consciousness causes collapse; observer "creates" reality; QM implies idealism.
...
**Recommendation:** Frame as structural analogy between epistemological lessons of QM and contemplative epistemologies. Cite specific formal results (Bell, contextuality, complementarity), not vague "observer" invocations. Acknowledge consciousness-collapse is a minority/abandoned position.

## Extraction Status

- claims extracted: yes (interpretations, contextuality, established vs. speculative)
- concepts linked: observer, sunyata (structural parallel), dependent-origination (structural parallel)
