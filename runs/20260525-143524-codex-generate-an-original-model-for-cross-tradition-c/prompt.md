...
Generate an original model for cross-tradition convergence without collapsing analogy into evidence.
...
- Create a formal run schema for recursive research cycles.
- Define claim and hypothesis JSON schemas.
- Add a minimal scheduler/worker implementation.
- Add Claude Code findings to the agent ledger once available.
